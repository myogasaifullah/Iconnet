            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 d-flex">
                    ...
                    <div class="container mt-5 p-5 mb-4">
                        <div class="me-3">
                            <img src="assets/ketut.jpg" class="img-fluid rounded mb-4" alt="Gambar 1">
                        </div>
                    </div>

                    <!-- Gambar 2 dan 3 (Vertikal atas-bawah) -->
                    <div>
                        <img src="assets/pavel.jpg" class="img-fluid rounded mb-4" alt="Gambar 2">
                        <img src="assets/rizky.jpg" class="img-fluid rounded" alt="Gambar 3">
                    </div>
                </div>
