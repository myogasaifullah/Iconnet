        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active menu-link fw-bold" aria-current="page" href="{{ route('promo') }}">Promo</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="promo" class="bg-light py-10">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap gap-6 justify-center">
                <!-- Card 1 -->
                <div class="card bg-white shadow-md rounded-lg p-4 w-80">
                ...
                <!-- Card 2 -->
                <div class="card bg-white shadow-md rounded-lg p-4 w-80">
                    <img src="https://api.stroom.id/v1/file/asset/load/jpg/ntjoqkpn3m"
                        class="w-full h-52 object-cover rounded mb-4"
                        alt="Gambar Promo 2">
                </div>
                ...
                <!-- Card 3 -->
                <div class="card bg-white shadow-md rounded-lg p-4 w-80">
                    <img src="https://kaltimtoday.co/wp-content/uploads/2023/01/Promo-Iconnect-PLN.png"
                        class="w-full h-52 object-cover rounded mb-4"
                        alt="Gambar Promo 3">
                </div>
                ...
                <!-- Card 4 -->
                <div class="card bg-white shadow-md rounded-lg p-4 w-80">
                    <img src="https://api.stroom.id/v1/file/asset/load/png/ngjpa6slql"
                        class="w-full h-52 object-cover rounded mb-4"
                        alt="Gambar Promo 4">
                </div>
            </div>
